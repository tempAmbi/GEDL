...
![](https://github.com/tempAmbi/GEDL/tree/master/images/overview_conf.eps)

And the process of using the codebook is shown as the following figure.
For text encryption:
![](https://github.com/tempAmbi/GEDL/tree/master/images/process2.eps)
For image encryption:
![](https://github.com/tempAmbi/GEDL/tree/master/images/process_image.eps)
